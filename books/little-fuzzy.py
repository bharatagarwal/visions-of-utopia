...
chapter1 = """Jack Holloway found himself squinting, the orange sun full in his eyes. He
...
chapter2 = """Jack Holloway landed the manipulator in front of the cluster of prefab
...
chapter3 = """He started awake, rubbed his eyes and looked at the clock. Past twenty-two
...
chapter4 = """The Fuzzies took the manipulator quite calmly the next morning. That
...
chapter5 = """Victor Grego crushed out his cigarette slowly and deliberately.
...
chapter6 = """The recorded voice ceased; for a moment the record player hummed
...
chapter7 = """Tuesday dawned hot and windless, a scarlet sun coming up in a hard, brassy
...
chapter8 = """Jack Holloway had been out on bail before, but never for quite so much. It
...
chapter9 = """Jack Holloway saw Little Fuzzy eying the pipe he had laid in the ashtray,
...
chapter10 = """Colonial Marshal Max Fane was as heavy as Gus Brannhard and considerably
...
chapter11 = """The two lawyers had risen hastily when Chief Justice Pendarvis entered; he
...
chapter12 = """Ben Rainsford went back to Beta Continent, and Gerd van Riebeek remained
...
chapter_XIII = """The management of the Hotel Mallory appeared to have undergone a change of
...
chapter_XIV = """They walked together, Frederic and Claudette Pendarvis, down through the
...
chapter15 = """Ernst Mallin shrank, as though trying to pull himself into himself, when
...
chapter_XVI = """They stopped whispering at the door, turned right, and ascended to the
...
chapter_XVII = """Ruth Ortheris sipped at the tart, cold cocktail. It was good; oh, it was
