...
chapter1 = """Up at the League, says a friend, there had been one night a brisk
...
chapter2 = """Well, I awoke, and found that I had kicked my bedclothes off; and no
...
chapter3 = """I lingered a little behind the others to have a stare at this house,
...
chapter4 = """We turned away from the river at once, and were soon in the main road
...
chapter5 = """Past the Broadway there were fewer houses on either side.  We presently
...
chapter6 = """As he spoke, we came suddenly out of the woodland into a short street of
...
chapter7 = """And now again I was busy looking about me, for we were quite clear of
...
chapter8 = """We now turned into a pleasant lane where the branches of great
...
chapter9 = """"Your kinsman doesn't much care for beautiful building, then," said I, as
...
chapter10 = """"Well," said the old man, shifting in his chair, "you must get on with
...
chapter11 = """"Now," said I, "I have come to the point of asking questions which I
...
chapter12 = """"Well," I said, "about those 'arrangements' which you spoke of as taking
...
chapter13 = """Said I: "How do you manage with politics?"
...
chapter14 = """Said I: "How about your relations with foreign nations?"
...
chapter15 = """"Yes," said I.  "I was expecting Dick and Clara to make their appearance
...
chapter16 = """As I spoke, I heard footsteps near the door; the latch yielded, and in
...
chapter17 = """Dick broke the silence at last, saying: "Guest, forgive us for a little
...
chapter18 = """"Well," said I, "so you got clear out of all your trouble.  Were people
...
chapter19 = """I said nothing, for I was not inclined for mere politeness to him after
...
chapter20 = """Amidst such talk, driving quietly through the balmy evening, we came to
...
chapter21 = """When I did wake, to a beautiful sunny morning, I leapt out of bed with my
...
chapter22 = """So on we went, Dick rowing in an easy tireless way, and Clara sitting by
...
chapter23 = """Though there were no rough noises to wake me, I could not lie long abed
...
chapter24 = """They were not slow to take my hint; and indeed, as to the mere time of
...
chapter25 = """As we went down to the boat next morning, Walter could not quite keep off
...
chapter26 = """Before we parted from these girls we saw two sturdy young men and a woman
...
chapter27 = """We set Walter ashore on the Berkshire side, amidst all the beauties of
...
chapter28 = """We started before six o'clock the next morning, as we were still twenty-
...
chapter29 = """Presently at a place where the river flowed round a headland of the
...
chapter30 = """On we went.  In spite of my new-born excitement about Ellen, and my
...
chapter31 = """As I stood there Ellen detached herself from our happy friends who still
...
chapter32 = """Dick brought me at once into the little field which, as I had seen from
