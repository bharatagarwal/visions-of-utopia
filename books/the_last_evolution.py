...
content = """I am the last of my type existing today in all the Solar System. I, too,
...
section1 = """It was 2538 years After the Year of the Son of Man. For six centuries
...
section2 = """The scenes were, of course, remembered by the memory-minds back on Earth
...
section3 = """He was interrupted. One of the newest science-machines was speaking.
...
section4 = """Flashes of fierce flame, sudden crashing arcs that glowed and snapped in
...
section5 = """Dawn was breaking again over Denver where this work had been done, when
...
section6 = """In Denver, two humans watched the screens that showed the movement of
...
section7 = """"We are alone, Trest," said Roal, "alone, now, in all the system, save
...
section8 = """There was a dull, drumming beat, a beat that rose, and became a
...
section9 = """The Outsiders left, going out across the void, and they have not
...
footnotes = """[1] Kilad--unit introduced by the machines. Based on the duodecimal
